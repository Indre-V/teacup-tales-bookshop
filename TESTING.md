...
| --------------------- | ---- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| index.html            | ✅    | [Result](/docs/testing-md/validations/landing-page-htmlchecker.png)      |                                                                                                                                                                                                  |
| product-list.html     | ✅    | ![Result](/docs/testing-md/validations/products-htmlchecker.png)         |                                                                                                                                                                                                  |
...
| manage-coupon.html    |      | ![Result](/docs/testing-md/validations/manage-coupon-htmlchecker.png)    | It intermitently throws an error for dropdown selection for percentage option. Based on online research there seems to be an ongoing html issue. All html code is updated to meet the standards. |
